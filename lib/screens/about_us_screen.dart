              ...
              () async {
                if (index == 0) {
                  checkIfLink(context, appStore.termConditions.validate(),
                      title: context.translate.lblTermsAndConditions);
                } else if (index == 1) {
                  checkIfLink(context, appStore.privacyPolicy.validate(),
                      title: context.translate.lblPrivacyPolicy);
                } else if (index == 2) {
                  checkIfLink(context, appStore.inquiryEmail.validate(),
                      title: context.translate.lblHelpAndSupport);
                } else if (index == 3) {
                  checkIfLink(context, appStore.helplineNumber.validate(),
                      title: context.translate.lblHelpLineNum);
                } else if (index == 4) {
                  {
