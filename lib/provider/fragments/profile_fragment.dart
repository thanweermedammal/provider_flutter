                ...
                children: [
                  ...
                  if (appStore.userProfileImage.isNotEmpty)
                    Stack(
                      ...
                      children: [
                        circleImage(
                            image: appStore.userProfileImage.validate(),
                            size: 120),
                        Positioned(
                          bottom: 0,
                          right: 8,
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              Text(context.translate.lblCurrentPlan,
                                  style: boldTextStyle(
                                      color:
                                          appStore.isDarkMode ? white : gray)),
                              Text(context.translate.lblValidTill,
                                  style: boldTextStyle(
                                      color:
                                          appStore.isDarkMode ? white : gray)),
                            ],
                  ...
                  children: [
                    ...
                    SettingItemWidget(
                      leading: Image.asset(
                        ...
                        width: 20,
                        color:
                            appStore.isDarkMode ? white : gray.withOpacity(0.8),
                      ),
